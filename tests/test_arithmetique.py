...
def test_addition_integer():
    assert arithmetique.additionner(2, 2) == 4.0
    assert arithmetique.additionner(-2, 3) == 1.0
    assert arithmetique.additionner(-2, -2) == -4.0
...
def test_soustraction_integer():
    assert arithmetique.soustraire(2, 2) == 0.0
    assert arithmetique.soustraire(-2, 3) == -5.0
    assert arithmetique.soustraire(-2, -2) == 0.0
...
def test_multiplication_integer():
    assert arithmetique.multiplier(2, 2) == 4.0
    assert arithmetique.multiplier(-2, 3) == -6.0
    assert arithmetique.multiplier(-2, -2) == 4.0
...
def test_division_integer():
    assert arithmetique.diviser(2, 2) == 1.0
    assert arithmetique.diviser(-2, 3) == -2.0 / 3
    assert arithmetique.diviser(-2, -2) == 1.0
